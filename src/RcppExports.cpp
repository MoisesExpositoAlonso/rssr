...
double rss_varbvsr_squarem_grid(const Eigen::SparseMatrix<double>& SiRiS, const double sigma_beta, const double logodds, const Eigen::ArrayXd& betahat, const Eigen::ArrayXd& se, const Eigen::ArrayXd& talpha0, const Eigen::ArrayXd& tmu0, const Eigen::ArrayXd& tSiRiSr0, double tolerance, int itermax, Rcpp::LogicalVector lnz_tol);
...
Eigen::MatrixXd grid_search_rss_varbvsr(const Eigen::MappedSparseMatrix<double> SiRiS, const Eigen::ArrayXd sigma_beta, const Eigen::ArrayXd logodds, const Eigen::ArrayXd betahat, const Eigen::ArrayXd se, const Eigen::ArrayXd talpha0, const Eigen::ArrayXd tmu0, const Eigen::ArrayXd tSiRiSr0, double tolerance, int itermax, Rcpp::LogicalVector verbose, Rcpp::LogicalVector lnz_tol);
...
// rss_varbvsr_update
void rss_varbvsr_update(const double betahat, const double se_square, const double sigma_beta_square, const double sigma_square, const Eigen::ArrayXd& SiRiS_snp, Eigen::ArrayXd& SiRiSr, const double SiRiSr_snp, const double logodds, double& alpha, double& mu);
RcppExport SEXP rssr_rss_varbvsr_update(SEXP betahatSEXP, SEXP se_squareSEXP, SEXP sigma_beta_squareSEXP, SEXP sigma_squareSEXP, SEXP SiRiS_snpSEXP, SEXP SiRiSrSEXP, SEXP SiRiSr_snpSEXP, SEXP logoddsSEXP, SEXP alphaSEXP, SEXP muSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rss_varbvsr_update(betahat, se_square, sigma_beta_square, sigma_square, SiRiS_snp, SiRiSr, SiRiSr_snp, logodds, alpha, mu);
    return R_NilValue;
END_RCPP
}
// SiRSi
